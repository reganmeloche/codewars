...
Test.assertEquals(blackOrWhiteKey(1), "white")
Test.assertEquals(blackOrWhiteKey(5), "black")
Test.assertEquals(blackOrWhiteKey(12), "black")
Test.assertEquals(blackOrWhiteKey(42), "white")
Test.assertEquals(blackOrWhiteKey(88), "white")
Test.assertEquals(blackOrWhiteKey(89), "white")
Test.assertEquals(blackOrWhiteKey(92), "white")
Test.assertEquals(blackOrWhiteKey(100), "black")
Test.assertEquals(blackOrWhiteKey(111), "white")
Test.assertEquals(blackOrWhiteKey(200), "black")
Test.assertEquals(blackOrWhiteKey(2017), "white")
})
