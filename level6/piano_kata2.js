...
function whichNote(keyPressCount) {
    return ["A", "A#", "B", "C", "C#", "D", "D#", "E", "F", "F#", "G", "G#"][((keyPressCount - 1)%88)%12];
}

// Test
Test.describe('Example tests',_=>{
Test.assertEquals(whichNote(1), "A")
Test.assertEquals(whichNote(5), "C#")
Test.assertEquals(whichNote(12), "G#")
Test.assertEquals(whichNote(42), "D")
Test.assertEquals(whichNote(88), "C")
Test.assertEquals(whichNote(89), "A")
Test.assertEquals(whichNote(92), "C")
Test.assertEquals(whichNote(100), "G#")
Test.assertEquals(whichNote(111), "G")
Test.assertEquals(whichNote(200), "G#")
Test.assertEquals(whichNote(2017), "F")
})
